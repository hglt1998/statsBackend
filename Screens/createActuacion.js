...
import { View, Button, TextInput, ScrollView, StyleSheet, Switch, Text, KeyboardAvoidingView, Image } from "react-native";
					...
					<ScrollView style={styles.container}>
						<View style={styles.card}>
							<View style={styles.switch}>
								<View style={styles.switchGroup}>
									<Switch
										...
										value={state.isLive}
									/>
									{state.isLive ? <Text style={styles.switchFont}>DIRECTO</Text> : <Text style={styles.switchFontFalse}>NO DIRECTO</Text>}
								</View>
								<View style={styles.button}>
									<Button color="#FFFFFF" title={"Guardar"} onPress={saveActuacion} />
								</View>
							...
							<View style={styles.inputGroup}>
								...
								<TextInput style={styles.placeholder} placeholderTextColor="#46596B" placeholder="Concierto de..." onChangeText={(value) => handleChangeText("concepto", value)} returnKeyType="next" />
							</View>
							<View style={styles.inputGroup}>
								<Text style={styles.textLabel}>Fecha</Text>
								<DateTimePickerModal mode="datetime" value={state.fecha} themeVariant="light" onChange={(value) => handleChangeText("fecha", new Date(value.nativeEvent.timestamp))} />
							</View>
							<View style={styles.inputGroup}>
							...
							<View style={styles.inputGroup}>
								...
								<TextInput style={styles.placeholder} placeholderTextColor="#46596B" placeholder="Ciudad del evento" onChangeText={(value) => handleChangeText("ciudad", value)} returnKeyType="next" />
							</View>
